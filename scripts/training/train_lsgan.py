...
from flipad.networks.lsgan import LSGANDiscriminator, LSGANGenerator
...
parser.add_argument(
    "--outf",
    default="trained_models/lsgan",
    help="folder to output images and model checkpoints",
)
parser.add_argument("--manualSeed", type=int, help="manual seed")
parser.add_argument("--num_layers", type=int, choices=[3, 4], default=3)
parser.add_argument(
    "--n_critic",
    type=int,
    default=5,
...
if opt.num_layers == 3:
    netG = LSGANGenerator(opt.nz, nc, opt.imageSize)
    netD = LSGANDiscriminator(nc, opt.imageSize)
else:
    netG = LSGANGenerator(opt.nz, nc, opt.imageSize, size="big")
    netD = LSGANDiscriminator(nc, opt.imageSize, size="big")
