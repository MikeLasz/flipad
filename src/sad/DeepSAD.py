...
from sad.optim.ae_trainer import AETrainer
from sad.optim.DeepSAD_trainer import DeepSADTrainer
...
class DeepSAD(object):
    ...
    def set_network(self, net_name, num_select_channels=128, rep_dim=128, kwargs={}):
        """Builds the neural network phi."""
        self.net_name = net_name
        self.net = build_network(net_name, num_select_channels=num_select_channels, rep_dim=rep_dim, kwargs=kwargs)
    ...
    def train(
        ...
        tolerable_fnr: list = [0.0, 0.001, 0.01, 0.005],
        l1_reg: float = 0.0,
        crop_size: int = 0,
    ):
        ...
        # Get the model
        self.net = self.trainer.train(dataset, self.net, self.tolerable_fnr)
    ...
    def pretrain(
        ...
        self.ae_net = build_autoencoder(self.net_name, kwargs=kwargs)
