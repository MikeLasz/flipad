...
@click.option("--weight_decay", type=float, default=1e-6, help="Weight decay (L2 penalty) hyperparameter.")
...
@click.option("--vae_lr", type=float, default=0.001, help="Initial learning rate for pretraining. Default=0.001")
