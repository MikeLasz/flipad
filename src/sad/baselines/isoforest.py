...
class IsoForest(object):
    ...
    def __init__(
        self, hybrid=False, n_estimators=100, max_samples="auto", contamination=0.1, n_jobs=-1, seed=None, **kwargs
    ):
        ...
        self.results = {"train_time": None, "test_time": None, "test_auc": None, "test_scores": None}
    ...
    def train(self, dataset: BaseADDataset, device: str = "cpu", n_jobs_dataloader: int = 0):
        ...
        train_loader = DataLoader(
            dataset=dataset.train_set, batch_size=128, shuffle=True, num_workers=n_jobs_dataloader, drop_last=False
        )
