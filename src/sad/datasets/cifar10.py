...
from sad.base.torchvision_dataset import TorchvisionDataset
from sad.datasets.preprocessing import create_semisupervised_setting
...
class CIFAR10_Dataset(TorchvisionDataset):
    def __init__(
        ...
        # Get train set
        train_set = MyCIFAR10(
            root=self.root, train=True, transform=transform, target_transform=target_transform, download=True
        )
        ...
        self.test_set = MyCIFAR10(
            root=self.root, train=False, transform=transform, target_transform=target_transform, download=True
        )
